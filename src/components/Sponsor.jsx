...
const Sponsor = () => {
    return (
        <>
            <div id='SPONSORS'>
                <div className='mx-auto mt-[27px] relative'>
                    <div className="xl:w-7/12 w-full bg-[url('./assets/images/png/sponsororgimg.png')] relative z-10 md:pt-[118px] pt-[57px] md:pb-[100px] pb-[57px] lg:bg-FullSize bg-cover bg-center">
                        <div className='flex items-center 2xl:justify-end 2xl:pr-[62px] justify-center px-4'>
                            <p className='text-[36px] font-black text-white max-w-[854px] text-center sm:mb-[32px] mb-[24px] leading-[135%]'>Interested in becoming a sponsor and getting exposure to our audience?</p>
                        </div>
