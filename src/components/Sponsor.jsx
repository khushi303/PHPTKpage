        ...
        <>
            <div id='SPONSORS'>
                <div className='mx-auto sm:mt-[27px] mt-[20px] relative'>
                    <div className="xl:w-[53%] w-full bg-[url('./assets/images/png/sponsororgimg.png')] relative z-10 md:pt-[118px] pt-[57px] md:pb-[100px] pb-[57px] lg:bg-FullSize bg-FullSize2 lg:bg-center bg-Lefttop">
                        <div data-aos="zoom-in-up" className='flex items-center justify-center px-4'>
                            <p className='2xl:text-[36px] md:text-[30px] text-[20px] font-black text-white sm:max-w-[854px] text-center max-w-[293px] sm:mb-[32px] mb-[24px] leading-[135%]'>Interested in becoming a sponsor and getting exposure to our audience?</p>
                        </div>
